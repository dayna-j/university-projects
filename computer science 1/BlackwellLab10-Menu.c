...
#include <stdio.h>
void printName(void);						// function prototype for printName function.  
void countDown(void);						// function prototype for countDown function.  

int main (void)
{
	int menu = 0;						// menu integer variable will serve as input to a switch 
																		// two functions.
	puts("");
